    ...
    <>
      ...
      <section className="gradient-primary relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 lg:px-6 py-8 lg:py-12">
          <Link
            href="/agents"
            className="inline-flex items-center gap-1 text-white/70 hover:text-white text-sm mb-5 transition-colors"
          >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-white/60 text-xs lg:text-sm flex flex-wrap gap-x-3 gap-y-1 tabular-nums">
          ...
          <p className="text-white/80 text-sm lg:text-base mt-5 leading-relaxed max-w-2xl">
            {agent.description}
          </p>
